...
int main() {
    uint64_t st = 0, et = 0, avgScaled = 0, avgLambda1 = 0;
    double errorScaled = 0, errorLambda1 = 0;
    volatile double resultScaled = 0, resultLambda1 = 0;

    omp_set_num_threads(4); 

    #pragma omp parallel for reduction(+:avgScaled, errorScaled, resultScaled, avgLambda1, errorLambda1, resultLambda1)
    ...
    printf("Dummy output to keep computations: Scaled: %f, Lambda1: %f\n", resultScaled, resultLambda1);
